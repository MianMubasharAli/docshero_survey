      ...
      child: Column(
        children: [
          RadioListTile(
              ...
              provider.surveyModel?.steps?[provider.questionsIndex].value?.questions?[provider.chaptersQuestionsIndex].value?.configuration?.options?[widget.index].id,
              ...
              // calculations(widget.index);
                  if(provider.surveyModel?.steps?[provider.questionsIndex].type == "question"){
                    provider.optionSingle(provider.surveyModel!.steps![provider.questionsIndex].value!.configuration!, widget.index);
                  }else{
                    provider.optionSingle(

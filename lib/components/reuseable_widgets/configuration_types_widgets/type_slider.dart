                ...
                child: SfSlider(
                  ...
                  onChanged: (dynamic value){
                    ...
                    if(provider.surveyModel!.steps![provider.questionsIndex].type == "question"){
                      ...
                      //       checkIndexForConditionString++;
                      //       conditionList.add(
                      //           "(${provider.surveyModel!.steps![provider
                      //               .questionsIndex].value!.configuration!
                      //               .options?[widget.index].value} "
                      //               "${element2.condition} ${element2
                      //               .value}) ${ checkIndexForConditionString <
                      //               element.options!.length ? element
                      //               .options![checkIndexForConditionString]
                      //               .optionOperator : ""}");
                      //     });
                      //
                      //     condition = conditionList.join(" ");
                      ...
                      //
                      //         if (checkExistenceOfProduct == true) {
                      //           int index = provider.productList.indexWhere((
                      //               element4) {
                      //             return element4.id == element3.id;
                      //           });
                      //
                      //           var encodedFoundProduct = jsonEncode(
                      //               provider.productList[index]);
                      //           Map<String,
                      //               dynamic> decodedFoundProduct = jsonDecode(
                      //               encodedFoundProduct) as Map<String,
                      //               dynamic>;
                      //           OptionProduct2 foundProduct = OptionProduct2
                      //               .fromJson(decodedFoundProduct);
                      //
                      //           bool? isContains = foundProduct.belongsTo
                      //               ?.contains(element.id);
                      //           if (!isContains!) {
                      ...
                      //           var parsedQuantityFoundProduct = provider
                      //               .checkForFormula(foundProduct.quantity)
                      //               ? provider.executeFormula(foundProduct)
                      //               : provider.isJSON(foundProduct.quantity)
                      //               ? provider.result(foundProduct.quantity)
                      //               : int.parse(foundProduct.quantity.toString());
                      //           var parsedQuantity = provider.checkForFormula(
                      //               element3.quantity)
                      ...
                      //           OptionProduct2 modifiedProduct = OptionProduct2
                      //               .fromJson(decoded);
                      //           var parsedQuantity = provider.checkForFormula(
                      ...
                      //               ? provider.result(modifiedProduct.quantity)
                      //               : int.parse(
                      //               modifiedProduct.quantity.toString());
                      //           modifiedProduct.quantity = parsedQuantity;
                      //           modifiedProduct.salePrice = (double.parse(
                      //               modifiedProduct.quantity.toString()) *
                      //               double.parse(element3.salePrice.toString()))
                      //               .toString();
                      //
